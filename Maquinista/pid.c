...
integer pointers.
------------------------------------------------------------------------*/
void pid_init(a, pv, sp) struct _pid *a;
int *pv, *sp;
{
    a->pv = pv;
    a->sp = sp;
...
------------------------------------------------------------------------*/
void pid_tune(a, p_gain, i_gain, d_gain, dead_band) struct _pid *a;
...
ALSO SEE pid_tune
------------------------------------------------------------------------*/
void get_gains(a, p_gain, i_gain, d_gain, dead_band) struct _pid *a;
float *p_gain, *i_gain, *d_gain;
int *dead_band;
{
    *p_gain = a->pgain;
...
------------------------------------------------------------------------*/
void pid_setinteg(a, new_integ) struct _pid *a;
float new_integ;
{
...
------------------------------------------------------------------------*/
void pid_bumpless(a) struct _pid *a;
{
...
------------------------------------------------------------------------*/
float pid_calc(a) struct _pid *a;
{
    int err;
